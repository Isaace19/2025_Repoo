...
#include <string.h>
#include <unistd.h>
#include "mqueue.h" // some bullshit that you have to do to work on mqueue on a macbook that does not support POSIX
// TODO: Have to verify with plank documents to see if I can do this on local. If not we will run virtual machine
#include <sys/wait.h>
